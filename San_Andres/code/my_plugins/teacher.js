...
jsPsych.plugins["teacher"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      prompt_espera: {
        ...
        default: "ESPERANDO QUE JUEGUE TU COMPAÑERO",
  ...
  plugin.trial = function(display_element, trial) {
    ...
    draw_main_rectangle(); //////////////////////////////// FIRST FUNCTION CALL
...
//      var dify2 = Math.abs((yb-y)-height) / height;
      ...
      if(won || limit){
        //pasar de nivel
        trial_data.won = won;
        trial_data.score=100-10*Examples.length;
        jsPsych.node.socket.emit('end_trial', {won: won, score:100-10*Examples.length});
        end_trial();
      }else{
        //nuevos puntos
        drawn_examples = 0;
