jsPsych.plugins['waiting-room'] = (function(){
    ...
    parameters: {
     title: {
      ...
      text: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Text',
        default:  'The experiment will begin as soon as enough people have joined.',
        description: ''
      },
      experiment: {
        type: jsPsych.plugins.parameterType.STRING,
  ...
  plugin.trial = function(display_element, trial){
    ...
    var html = "<div class='mdl-card mdl-shadow--2dp'>"+
      ...
      "<div class='mdl-card__supporting-text' id='room-updates'><small>"+trial.experiment+"</small></div>"+
    ...
    jsPsych.node.socket.on('ready-check', function(message){
      jsPsych.node.socket.emit('ready-reply',{});
    });
