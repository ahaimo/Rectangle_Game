...
jsPsych.plugins["check_point_button"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'check_point_button',
    description: '',
    parameters: {
      stimulus: {
      ...
      background_image:{
        ...
        default: "", // none
        description: 'Path to the background image to be shown'
      },
      prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Prompt',
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function set_background() {
      ...
      document.body.style.backgroundImage = "url('"+trial.background_image+" ')" ;
    };
